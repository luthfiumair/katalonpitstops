...
WebUI.click(findTestObject('Object Repository/Config 2/Execution/Execution'))

WebUI.doubleClick(findTestObject('Object Repository/Config 2/Execution/EWR'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/Contractor'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/Contractor - 2'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/Apply'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/New Item/Add'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/New Item/Contractor - 3'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/Apply - 2'))

WebUI.click(findTestObject('Object Repository/Config 2/Execution/New Item/R.Category'))