...
WebUI.click(findTestObject('Object Repository/Config 2/Approval/Dropdown'))

WebUI.setText(findTestObject('Object Repository/Config 2/Approval/Text'),'EWR Config 2 Remark Approve')

WebUI.click(findTestObject('Object Repository/Config 2/Approval/Approve'))

WebUI.click(findTestObject('Object Repository/Config 2/Approval/Yes'))

WebUI.click(findTestObject('Object Repository/Config 2/Approval/Okay'))
